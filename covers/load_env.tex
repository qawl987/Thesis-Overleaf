...
% \setCJKmainfont[Path={C:/Users/Fang Kai/AppData/Local/Microsoft/Windows/Fonts/},Extension=.ttf]{TW-Kai-98}
\setCJKmainfont[Path=./fonts/,Extension = .ttf,AutoFakeBold = {4},AutoFakeSlant = 0.2]{TW-Kai-98}
